...
@section('title', 'Owner - Lupa Kata Sandi')
...
@section('content')
    <div class="col-11 col-md-6 col-lg-5 col-xl-4 shadow border p-3 bg-white">
        ...
        <form class="row" method="POST" action="{{ route('owner.forgot-password.send') }}" id="forgotPasswordForm">
            ...
            <div class="col-12">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('owner.login.show') }}" class="text-decoration-none" id="toLoginPageButton">
                            Halaman Login
                        </a>
                    </div>
                </div>
...
@push('scripts')
    <script defer src="{{ url('assets/js/owner/forgot-password.js') }}"></script>
@endpush