...
@section('title', 'Owner - Profil')

@section('description', 'Halaman yang menampilkan profil owner.')
...
@section('content')
    <div class="col-11 shadow border p-3 bg-white align-self-start">
        ...
        <div class="border-top pt-3">
            ...
            @endif
            <a href="{{ route('owner.profile.edit') }}" class="btn btn-secondary float-end mb-2">
                Ubah
            </a>
