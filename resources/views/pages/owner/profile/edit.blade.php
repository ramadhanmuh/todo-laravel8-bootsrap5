...
@section('title', 'Owner - Profil - Ubah')

@section('description', 'Halaman yang menampilkan formulir pengubahan profil owner.')
...
@section('content')
    <div class="col-11 shadow border p-3 bg-white align-self-start">
        ...
        <div class="border-top pt-3">
            ...
            @endif
            <form action="{{ route('owner.profile.update') }}" method="post" class="row">
                @csrf
                @method('PUT')
                ...
                <div class="col-auto">
                    <a href="{{ route('owner.profile.index') }}" class="btn btn-light border border-dark">
                        Kembali
                    </a>
                </div>
            </form>
