...
@section('content')
    <div class="col-11 col-md-6 col-lg-5 shadow border p-3 bg-white">
        <h1 class="text-center mb-3">Atur Ulang Kata Sandi</h1>
        ...
        <form class="row" method="POST" action="{{ route('reset-password.save') }}" id="resetPasswordForm">
...
@push('scripts')
    <script defer src="{{ url('assets/js/reset-password.js') }}"></script>
@endpush