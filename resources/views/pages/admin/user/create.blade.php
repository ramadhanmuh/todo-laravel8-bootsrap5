...
@section('title', 'Administrator - Pengguna - Tambah')
        ...
        <div class="border-top pt-3">
            ...
            <form action="{{ route('admin.users.store') }}" class="row" method="POST">
                ...
                <div class="col-12">
                    ...
                    <a href="{{ url()->previous() === route('admin.users.create') ? route('admin.users.index') : url()->previous() }}" class="btn btn-light border border-dark">Kembali</a>
                </div>
            </form>
        </div>
    </div>
