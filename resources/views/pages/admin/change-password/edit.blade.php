...
@section('title', 'Administrator - Ubah Kata Sandi')

@section('description', 'Halaman yang menampilkan formulir pengubahan kata sandi administrator.')
...
@section('content')
    <div class="col-11 col-md-7 col-lg-6 col-xl-5 shadow border p-3 bg-white align-self-start">
        ...
        <div class="border-top pt-3">
            ...
            @endif
            <form action="{{ route('admin.change-password.update') }}" method="post" class="row">
                @csrf
                @method('PUT')
