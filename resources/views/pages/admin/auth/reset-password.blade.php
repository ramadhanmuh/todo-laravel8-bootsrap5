...
@section('title', 'Admin - Atur Ulang Kata Sandi')
...
@section('content')
    <div class="col-11 col-md-6 col-lg-5 shadow border p-3 bg-white">
        ...
        <h5 class="text-center mb-3">(Administrator)</h5>
        ...
        <form class="row" method="POST" action="{{ route('admin.reset-password.save') }}" id="resetPasswordForm">
...
@push('scripts')
    <script defer src="{{ url('assets/js/admin/reset-password.js') }}"></script>
@endpush