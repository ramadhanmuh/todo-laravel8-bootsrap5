...
@section('description', 'Halaman yang menampilkan formulir login untuk administrator.')
...
@section('content')
    <div class="col-11 col-md-6 col-lg-5 col-xl-4 shadow border p-3 bg-white">
        ...
        <form class="row" method="POST" action="{{ route('admin.login.authenticate') }}" id="loginForm">
...
@push('scripts')
    <script defer src="{{ url('assets/js/admin/login.js') }}"></script>
@endpush